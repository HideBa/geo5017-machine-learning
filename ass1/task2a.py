...
def main():
    ...
    print("-------------x--------------")
    print("coefficient a0: ", x_a0)
    print("coefficient a1: ", x_a1)
    print("-------------x--------------")
    print("-------------y--------------")
    print("coefficient a0: ", y_a0)
    print("coefficient a1: ", y_a1)
    print("-------------y--------------")
    print("-------------z--------------")
    print("coefficient a0: ", z_a0)
    print("coefficient a1: ", z_a1)
    print("-------------z--------------")
